...
# pd_obsm = scv.read_csv("/Users/laura/Documents/Data/Peri/embednonames.csv")
...
# -----------------------------------------------------------------------------------
# Merged Periodontium 1, 2, 3 and 6
sdata 						= scv.read('/Users/delaura/Documents/Tooth/AllPerio/merged/sf.loom', cache=True)
ndata 						= scv.read('/Users/delaura/Documents/Tooth/AllPerio/merged/uf.loom', cache=True)
# sdata 						= scv.read('/Users/laura/Documents/Data/perio/bustools_spliced_unspliced/mergednamed/sf.loom', cache=True)
# ndata 						= scv.read('/Users/laura/Documents/Data/perio/bustools_spliced_unspliced/mergednamed/uf.loom', cache=True)
# testdata 					= scv.read('/Users/laura/Documents/Data/Peri/spliced.loom', cache=True) # we use this to get the umap coords/clusters. 
sdata.layers['spliced'] 	= sdata.X
...
# import umap embeddings from R (Seurat) and add to anndata object
data_folder 			= "/Users/delaura/Documents/Tooth/AllPerio/merged"
...
# scv.pl.velocity_embedding_stream(sdata, basis='umap') # I find the stream visuals to look decieving 
scv.pl.velocity_embedding_grid(sdata, basis='umap', save= "perio_grid.pdf", dpi = 150)
